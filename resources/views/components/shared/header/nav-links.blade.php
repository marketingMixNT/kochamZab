<ul
    class="flex flex-col lg:flex-row justify-center items-center gap-8 md:gap-12 lg:gap-8 xl:gap-12  ">
            ...
            <x-shared.header.nav-item href="{{ route('restaurant.index') }}"> Gastronomia</x-shared.header.nav-item>
            <x-shared.header.nav-item href="{{ route('contact.index') }}" class="lg:hidden"> Kontakt</x-shared.header.nav-item>
