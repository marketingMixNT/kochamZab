...
<div id="navbar" class="sticky top-0 px-4 sm:px-10 2xl:px-0 bg-bgLight-400 dark:bg-bgDark-400 z-50 shadow-2xl">
    ...
    <nav id="menu"
        ...
        <x-shared.nav.nav-links />
        {{-- other --}}
        <x-shared.nav.theme-toggle class="absolute top-4 right-4 lg:hidden" />
        <x-shared.socials class="absolute bottom-4 left-4 lg:hidden" />
        <x-shared.nav.language-switcher class="absolute bottom-4 right-4 lg:hidden text-fontLight" />
    </nav>
</div>
