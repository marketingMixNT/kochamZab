        ...
        <article class="space-y-20">
            <div class="flex gap-6 ">
                <div class="w-1/2">
                    ...
                    <span class="font-heading uppercase text-lg font-black text-secondary-400 ">Kocham Ząb</span>
                    <h2 class="text-4xl lg:text-5xl  text-fontBlue dark:text-fontLight font-black  uppercase mb-6">
                        Poznaj Naszą Historię</h2>
                </div>
                <div class="w-1/2">
            ...
            <div>
                <img src="{{ asset('assets/images/zab.jpg') }}" alt="" class="aspect-video w-full">
            </div>
