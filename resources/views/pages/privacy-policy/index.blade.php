<x-layouts.app title="Polityka prywantości | Kocham Ząb"
    description="Zapoznaj się z naszą polityką prywatności. Dowiedz się jak nasi użytkownicy korzystają z naszej strony i jak wykorzystywane są dane.">


<x-slot:header>
    <x-banner img="{{asset('assets/images/o-nas-4.webp')}}">Polityka Prywatności</x-banner>

</x-slot:header>

<x-slot:main>
    <x-base.section class="max-w-screen-lg mx-auto">
       
        <article class="prose ">
            <h2>1. Informacje ogólne</h2>
            <p>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <a href="http://kochamzab.pl">kochamzab.pl</a></p>
            <p>Operatorem serwisu oraz Administratorem danych osobowych jest: Michał Sobański</p>
            <p>Adres kontaktowy poczty elektronicznej operatora: <a href="mailto:kontakt@kochamzab.pl">kontakt@kochamzab.pl</a></p>
